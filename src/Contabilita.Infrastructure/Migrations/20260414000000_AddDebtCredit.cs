...
{
    /// <inheritdoc />
    public partial class AddDebtCredit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DebtCredits_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DebtCredits_UserId_IsSettled_DueDate",
                table: "DebtCredits",
                columns: new[] { "UserId", "IsSettled", "DueDate" });
        }
